 ...
 * set env variable:
    ...
    to let the local deployed CodeCycle instances in different devices share the same extension id, by which sync data will be
...
console.log(
  `Manifest generated for ${isDev ? "development" : "production"} environment`
);
